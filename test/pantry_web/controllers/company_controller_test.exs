defmodule PantryWeb.CompanyControllerTest do
  use PantryWeb.ConnCase

  alias Pantry.Orgs

  @create_attrs %{address: "some address", email: "some email", landline: "some landline", mobile: "some mobile", name: "some name"}
  ...
  def fixture(:company) do
    {:ok, company} = Orgs.create_company(@create_attrs)
    company
  end
